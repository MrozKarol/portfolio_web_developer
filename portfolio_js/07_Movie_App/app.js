...
const showMovies = (movies) => {
    ...
    movies.forEach((movie) => {
        const { title, original_title, poster_path, vote_average, overview, } = movie
        const movieEl = document.createElement('div')
        movieEl.classList.add('movie')

        movieEl.innerHTML = `
        <img src="${poster_path ? IMG_PATH + poster_path : 'https://images.unsplash.com/photo-1610337673044-720471f83677?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1566&q=80'}"
                alt="movie">
